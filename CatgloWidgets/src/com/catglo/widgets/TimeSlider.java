...
public class TimeSlider extends DateSlider {
	...
	public TimeSlider(Context context, OnDateSetListener l, Calendar calendar, String label) {
	...
	protected void setTitle() {
		if (mTitleText != null) {
			mTitleText.setText(String.format("Selected Time: %tR %tA",mTime,mTime)); 
		}
		if (dateLabel != null){
			dateValue.setText(String.format("%tl:%tM %tp %ta %tb %te %tY",mTime,mTime,mTime,mTime,mTime,mTime,mTime));
		}
